...
from    HLaSDI.Rollouts                        import  Sample_Rollouts;
from    HLaSDI.Plotting.Metrics                import  Compute_Meltpool_Dimensions;
...
def _get_param_grid_1d(param_space : ParameterSpace, param_index : int) -> numpy.ndarray:
    """
    Extract the one-dimensional grid for one parameter from HLaSDI.ParameterSpace.test_meshgrid.
