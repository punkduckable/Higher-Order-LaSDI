...
from    HLaSDI.Schemas                         import  TelegraphersPhysicsConfig;
from    HLaSDI.Physics                         import  Physics;
from    HLaSDI.Physics.PyMFEM.telegraphers     import  Simulate, Initial_Displacement, Initial_Velocity;
...
class Telegraphers(Physics):
    ...
    def solve(self, param : numpy.ndarray) -> tuple[list[torch.Tensor], torch.Tensor]:
        ...
        t_max   : float         = self.config.Telegraphers.t_max;
