...
from    HLaSDI.Schemas                         import  KleinGordonPhysicsConfig;
from    HLaSDI.Physics                         import  Physics;
from    HLaSDI.Physics.PyMFEM.klein_gordon     import  Simulate, Initial_Displacement, Initial_Velocity;
...
class KleinGordon(Physics):
    def __init__(self, config : KleinGordonPhysicsConfig, param_names : list[str]) -> None:
        ...
        super().__init__(   config         = config,
                            ...
                            Uniform_t_Grid = config.KleinGordon.uniform_t_grid,
                            n_IC           = 2);
    ...
    def solve(self, param : numpy.ndarray) -> tuple[list[torch.Tensor], torch.Tensor]:
        ...
        t_max   : float         = self.config.KleinGordon.t_max;
